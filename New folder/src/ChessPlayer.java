...
public class ChessPlayer {
	...
	private Double overAllScore;                           // Overall score which can be a floating number (Eg: avg = 4.6)
	...
	public int getChessPlayerNumber() { return ChessPlayerNumber;}
	public void setChessPlayerNumber(int ChessPlayerNumber) {this.ChessPlayerNumber = ChessPlayerNumber;}
	public Name getChessPlayerName() {return ChessPlayerName;}
	public void setChessPlayerName(String ChessPlayerName) {this.ChessPlayerName = new Name(ChessPlayerName);}
	public int getChessPlayerAge() {return ChessPlayerAge;}
	...
	public void setChessPlayerLevel(String ChessPlayerLevel) {this.ChessPlayerLevel = ChessPlayerLevel;}
	public String getChessPlayerGender() {return ChessPlayerGender;}
	public void setChessPlayerGender(String ChessPlayerGender) {this.ChessPlayerGender = ChessPlayerGender;}
	public int[] getChessPlayerScoresArray() {return ChessPlayerScoresArray;}
	public void setChessPlayerScoresArray(int[] ChessPlayerScores) {this.ChessPlayerScoresArray = ChessPlayerScores;}
	...
	// String formating to return the full details of the ChessPlayer.
	...
	// This method String formating to return the short details of the ChessPlayer.
	...
	public String getShortDetails() {
		...
		public String getChessPlayer_ScoresString() {
			...
			/*
	         *  Summary : it returns value of "sPassword"
	         *
	         *  Args    : no args
	         *
	         *  Returns : it returns value of "sPassword"
	         */
